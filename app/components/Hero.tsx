...
return ( <a
 ...
 >
{children} <span className="text-[17px] transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5">
↗ </span> </a>
);
}
...
return ( <section
   id="top"
   className="relative min-h-[100svh] overflow-hidden bg-[#050505] pt-16"
 > <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_18%,rgba(79,111,255,.16),transparent_34%)]" />
  ...
  <div className="relative z-[2] mx-auto w-full max-w-[1200px] min-w-0 px-5 sm:px-8 lg:px-10">
    <div className="grid min-h-[calc(100svh-64px)] items-center gap-12 py-[60px] lg:grid-cols-[minmax(0,1.12fr)_minmax(0,0.88fr)] lg:gap-10 lg:py-0">
      <div
        className="relative z-[5] min-w-0 max-w-full overflow-hidden [container-type:inline-size]"
      >
      ...
      <div
        className="relative min-w-0 max-w-full flex justify-center lg:justify-end lg:translate-x-0 xl:translate-x-0 max-[1100px]:order-first max-[1100px]:translate-x-0"
      >
        ...
        <div className="relative aspect-[5/6] w-full max-w-[520px] min-w-0 overflow-hidden rounded-[34px] border border-white/[0.08] bg-[#111] shadow-[0_0_0_1px_rgba(255,255,255,.04),0_50px_140px_rgba(0,0,0,.55)]">
          ...
          <div className="absolute left-7 right-7 top-7 z-[3] flex items-center justify-between">
            <div className="h-px w-[70px] bg-white/30" />

            <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/75 px-4 py-3 backdrop-blur-[20px]">
              <Icon name="circleDot" size={12} className="text-[#3B82F6]" />
          ...
          <div className="absolute bottom-[18px] left-[18px] right-[18px] z-[3] rounded-[22px] border border-white/[0.08] bg-black/[0.78] px-[22px] py-4 backdrop-blur-[24px] [container-type:inline-size]">
            <div className="flex flex-col items-end whitespace-nowrap font-bold leading-none tracking-[-0.035em] text-white">
              <div className="text-[clamp(16px,4cqw,28px)]">
                {hero.photo.principleTop}
              </div>

              <div className="mt-2 text-[clamp(24px,6cqw,44px)]">
